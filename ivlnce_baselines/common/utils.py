...
def extract_instruction_tokens(
    ...
    for i in range(len(observations)):
        if (
            ...
            observations[i]['instruction_text_for_keywords'] = observations[i][
...
def batch_obs(
    ...
    if ignore_keys is None:
        ignore_keys = {"env_name", 'instruction_text_for_keywords', 'keywords', 'rel_heading_feats', 'keywords_map', 'rel_distance_feats'}
