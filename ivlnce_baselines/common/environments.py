...
class VLNCEIterativeEnv(habitat.RLEnv):
    ...
    def reset(self) -> Tuple[Observations, bool, bool]:
        ...
        # assert prev_tour_id is None
        # assert self._env.current_episode.tour_id is None
        # assert not tour_done
    ...
    def _get_next_action_safe(
        ...
        try:
            ...
            logger.warn(
                ...
                f" Phase: {self._phase}"
                f" Episode Id: {self._env.current_episode.episode_id}"
            )
